...
rename table sql_blinkit_project16875985390 to Blinkit1;
...
#Q5 Write an SQL query to show average Item_Weight
select avg(Item_Weight) from Blinkit1;

#Q6 Write an SQL query to show minimum Item Weight.
...
select * from Blinkit1 order by Item_Type asc;
